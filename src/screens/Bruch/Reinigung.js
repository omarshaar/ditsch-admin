...
// api
import { getCleanedList, removeCleanedItem } from '../../service/main';
...
const Reinigung = () => {
    ...
    return (
        <div className='bruch-page'>
            <Containery>
                <div className='flex items-center justify-between'>
                    <p className="p2 titleP500"> Reinigung </p>
...
const TableContainer = () => {
    ...
    const getData = () =>  getCleanedList().then(handleCleanedList);
...
const TableRow = (props) => {
    ...
    const deleteAufgabe = (id) =>{
        ...
        removeCleanedItem(id).then(data => data == 'successfully' && props.reload());
    }
